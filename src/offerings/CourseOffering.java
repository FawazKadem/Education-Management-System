...
//	these classes if unsure of how this works
	public double calculateFinalGrade(String ID){
		...
		while(weights.hasNext()){
			...
			weights.next();
			if (marks.getValueWithKey(weights.getCurrentKey()) < 0){
		...
		if (!(gradesComplete)) {
			System.out.println("Not all grades have been entered. Final mark can't be calculated.") ;
			return -50; }
		return finalGrade;
	}
